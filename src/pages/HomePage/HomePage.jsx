...
export default function HomePage() {
    ...
    const desktopPosts = [
        ...
        {title:'Melhore seu performance', text:'Com base no histórico de questões respondidas, veja quais temas ou instituições têm as menores assertividades. Assim, é crie simulados totalmente personalizados para melhorar seu performance.', image:performance , button:'', path:''},
    ...
    const mobilePosts = [
        ...
        {title:'Melhore seu performance', text:'Histórico de questões com análises personalisadas.', image:performance , button:'', path:''},
